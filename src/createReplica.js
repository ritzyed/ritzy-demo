...
export default function createReplica(Swarm, id) {
  ...
  let content = [
    ...
    { 'text': ': line and editor navigation', 'attrs': {} },
    { 'text': '\n', 'attrs': null },
    { 'text': '* ', 'attrs': {} },
    ...
    { 'text': ' blinks just like Word and Google Docs: when waiting for input, but not while typing or navigating.', 'attrs': null },
    { 'text': '\n', 'attrs': null },
    { 'text': '\n', 'attrs': null },
    ...
    { 'text': 'Ctrl+i', 'attrs': {'italic': true} },
    { 'text': ' shortcut. Note that the cursor slants. A simple thing, but user friendly. How many web editors have this other than Google Docs?', 'attrs': {'italic': false} },
    { 'text': '\n', 'attrs': null },
    { 'text': '\n', 'attrs': null },
    { 'text': '* ', 'attrs': {} },
    { 'text': 'Selections', 'attrs': {'italic': true} },
    { 'text': ': Note that selection behavior, including end of line behavior with hard and soft returns, is very similar to Google Docs and Word. Try unfocusing the editor with an active selection and note that it "greys out". Try selecting overlapping text in this editor and another one.', 'attrs': {} },
    { 'text': '\n', 'attrs': null },
    { 'text': '\n', 'attrs': null },
    { 'text': '* ', 'attrs': {} },
    { 'text': 'Real-time (and offline!) collaborative editing', 'attrs': {'italic': true} },
    { 'text': ': try copying and pasting the URL of this editor above into another window or browser. In a moment you should see a colored "remote cursor" in each editor. Now navigate, select, and edit in one editor while watching the other. Try adding a third!', 'attrs': null },
    { 'text': '\n', 'attrs': null },
    { 'text': '\n', 'attrs': null },
    { 'text': '* ', 'attrs': {} },
    ...
    { 'text': '\n', 'attrs': null },
    { 'text': '\n', 'attrs': null },
    { 'text': 'Some big stuff not implemented yet:', 'attrs': null },
    { 'text': '\n', 'attrs': null },
